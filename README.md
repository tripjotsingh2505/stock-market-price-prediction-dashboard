...
> Stock markets are inherently volatile and hard to predict with precision. This project builds a **production-ready, end-to-end ML pipeline** that forecasts Reliance Industries' next-day closing price — trained on 16 years of live OHLCV data, powered by 30+ engineered technical features, and served through a fully interactive real-time dashboard.
...
Raw OHLCV data alone is a weak predictor — the real signal lives in *derived* features. All indicators were computed from scratch using Pandas and NumPy (no TA-Lib), keeping the pipeline fully transparent and portable.
...
Key patterns surfaced from 16 years of Reliance data:
...
Three commands and you're live — the app auto-fetches the latest data from Yahoo Finance on every launch.
...
Deployed on **Render** as a persistent web service — always live, no sleep mode. Three config files are all it takes.
...
> Built for **educational and portfolio purposes only.** Predictions are based on historical data and do **not** constitute financial advice. Always do your own research before making any investment decisions.

---

<div align="center">

## 👨‍💻 AUTHOR — TRIPJOT SINGH
