...
> This project is built entirely for **educational and portfolio purposes** as part of an end-to-end Data Science learning journey. The predictions, signals, and insights generated by this dashboard are powered by ML models trained on historical data — they do **not** constitute financial advice and should **not** be used as the sole basis for any investment decision. Past market patterns are no guarantee of future performance. Always conduct your own due diligence and consult a certified financial advisor before committing capital.
